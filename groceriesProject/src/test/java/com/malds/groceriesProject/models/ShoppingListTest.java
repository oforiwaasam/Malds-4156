...
public class ShoppingListTest {
        ...
        public void testGetShoppingListByID() throws Exception {
                ...
                final Map<String, String> EXPECTED_PRODUCT_ID_TO_QUANTITY =
                                new HashMap<String, String>();
                EXPECTED_PRODUCT_ID_TO_QUANTITY.put("445", "1");

                Map<String, String> productIDToQuantity =
                                new HashMap<String, String>();
                ...
                Mockito.when(shoppingListRepository.existsByID("1"))
                                .thenReturn(true);
                Mockito.when(shoppingListRepository.retriveList("1"))
                                .thenReturn(List.of(shoppingList));
                Mockito.when(shoppingListRepository.getShoppingListByID("1"))
                                .thenReturn(shoppingList);

                assertEquals(shoppingListService.getShoppingListByID("1").get(0)
                                .getShoppingListID(),
        ...
        public void testSaveShoppingList() throws Exception {
                ...
                Mockito.when(shoppingListRepository
                                .createShoppingList(shoppingList))
                                .thenReturn(shoppingList);
                assertEquals(shoppingListService
                                .createShoppingList(shoppingList).get(0)
                                .getShoppingListID(), EXPECTED_SHOPPINGLIST_ID);
                assertEquals(shoppingListService
                                .createShoppingList(shoppingList).get(0)
                                .getClientID(), EXPECTED_CLIENT_ID);
                assertEquals(shoppingListService
        ...
        public void testUpdateShoppingList() throws Exception {
                ...
                assertEquals(shoppingListService
                                .updateShoppingList(updatedShoppingList).get(0)
                                .getShoppingListID(),
                                updatedShoppingList.getShoppingListID());
                assertEquals(shoppingListService
                                .updateShoppingList(updatedShoppingList).get(0)
                                .getClientID(),
                ...
                assertEquals(shoppingListService
                                .updateShoppingList(updatedShoppingList).get(0)
                                .getProductIDToQuantity(),
                                updatedShoppingList.getProductIDToQuantity());
        ...
        public void testDeleteShoppingListByID() {
                ...
                Mockito.when(shoppingListRepository.existsByID("3"))
                                .thenReturn(true);
        ...
        public void testNoShoppingListIDUpdate() {
                ...
                Mockito.when(shoppingListRepository.existsByID("32"))
                                .thenReturn(false);
                ...
                assertEquals("Shopping List ID not found (Service: null; Status Code: 0; Error Code: null; Request ID: null; Proxy: null)",
        ...
        public void testNoShoppingListIDDelete() {
                ...
                assertEquals("This shoppingList ID doesn't exist (Service: null; Status Code: 0; Error Code: null; Request ID: null; Proxy: null)",
                                exception.getMessage());
        }
