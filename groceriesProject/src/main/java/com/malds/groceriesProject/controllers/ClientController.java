...
public class ClientController extends BaseController {
     ...
     * Throws Exception if clientID alredy exists or invalid inputs.
     * @param client
     ...
     * and returns the client with clientID.
     * Throws ResourceNotFoundException if clientID does not exist.
     * @param clientID
